...
@include('main.hero')
 ...
 <!-- ICONS SECTION -->
    ...
    <div class="flex flex-wrap justify-center gap-10 md:gap-20 -translate-y-12">

      <div class="flex flex-col items-center text-center">
        <div class="w-40 h-40 md:w-75 md:h-75 bg-red-600 rounded-full  flex flex-col items-center justify-center text-white shadow-xl">
          <img src="{{ asset('assets/icons/icon2.png') }}" class="w-16 h-16 mb-2  " />
          <span class="text-3xl font-bold">+250.000</span>
          <span class="font-bold text-xs uppercase tracking-widest">Goods Imported</span>
        </div>
      </div>
      ...
      <div class="flex flex-col items-center text-center">
        <div class="w-40 h-40 md:w-75 md:h-75 bg-red-600 rounded-full  flex flex-col items-center justify-center text-white shadow-xl">
          ...
          <span class="text-3xl font-bold">+300</span>
          <span class="font-bold text-xs uppercase tracking-widest">Clients Served</span>
        </div>
      </div>
    ...
    <div class="flex flex-col items-center text-center">
        <div class="w-40 h-40 md:w-75 md:h-75 bg-red-600 rounded-full flex flex-col items-center justify-center text-white shadow-xl">
          ...
          <span class="text-3xl font-bold">+1.000.000</span>
          <span class="font-bold text-xs uppercase tracking-widest">Miles Coverage</span>
        </div>
      </div>      
...
<section">
  <div class=" container mx-auto px-4 md:mb-16">
...
<section class="relative py-54 bg-cover bg-center" style="background-image: url('{{ asset('assets/images/strategic-warehouse.png') }}')">
...
<section class="py-20">
    <div class="container mx-auto px-4">
        ...
        <div class="text-center mt-16">
            <a href="{{ route('insight') }}" class="bg-red-700 text-white px-8 py-3 rounded-full font-bold hover:bg-red-800 transition">See All Articles</a>
        </div>
    </div>
</section>
...
<section class="relative py-24 bg-cover bg-center" style="background-image: url('{{ asset('assets/images/warehouse.png') }}')">
    ...
    <div class="relative z-10 container mx-auto px-4 text-center text-white">
        ...
        <div class="relative max-w-280 mx-auto">
            ...
            <div class="bg-white rounded-3xl p-8 md:p-30 shadow-2xl text-gray-800">
